...
<div class="main" id="mainContent">
    ...
    <div class="page-content">
        ...
        <div class="api-offline">
            ...
            <div>
                ...
                <p style="margin-top:10px;">
                    Once running, refresh this page. The server listens on <strong>http://127.0.0.1:5001</strong>.
                </p>
            </div>
        </div>
        <?php else: ?>
            ...
            <div class="custom-days-drop" id="customDaysDrop">
                ...
                <div class="custom-days-menu" id="customDaysMenu">
                    <?php foreach ([7, 14, 30, 60] as $d): ?>
                        <div class="custom-days-option<?= $d === $days ? ' selected' : '' ?>" data-value="<?= $d ?>">
        ...
        <div class="kpi-grid" style="margin-bottom:20px;">
            <div class="kpi-card">
                <div class="kpi-top">
                    ...
                    <div class="kpi-icon <?= $is_up ? 'green' : 'red' ?>">
                        <i class="fa-solid fa-arrow-trend-<?= $is_up ? 'up' : 'down' ?>"></i>
                    </div>
                </div>
                <div class="kpi-value trend-<?= $is_up ? 'up' : 'dn' ?>">
                    <?= $is_up ? 'Growing' : 'Declining' ?>
                </div>
            ...
            <div class="kpi-card">
                <div class="kpi-top">
                    <span class="kpi-label">Forecast Period</span>
                    <div class="kpi-icon orange"><i class="fa-solid fa-calendar-days"></i></div>
                </div>
            ...
            <div class="kpi-card">
                <div class="kpi-top">
                    <span class="kpi-label">Projected Revenue</span>
            ...
            <div class="kpi-card">
                <div class="kpi-top">
                    <span class="kpi-label">Projected Units</span>
            ...
            <div class="chart-card-header">
                <div>
                    ...
                    <div class="chart-subtitle">
                        Historical (last 30 days) + <?= $days ?>-day projection —
                        <?= $branch ? htmlspecialchars($branch) : 'All Branches' ?>
                    </div>
                </div>
            </div>
        ...
        <div class="chart-card">
            <div class="chart-card-header">
                <div>
                    <div class="chart-title">Stock-Out Risk Prediction</div>
                    <div class="chart-subtitle">Products ranked by days until stock-out</div>
                </div>
            </div>
            <table class="intel-table">
                <thead>
                    <tr>
                        ...
                        <th>SKU</th>
                        <th>Branch</th>
                        <th class="col-r">Units/30d</th>
                        <th class="col-r">Avg/Day</th>
                        <th class="col-r">Stock</th>
                        <th class="col-r">Days Left</th>
                        <th>Risk</th>
                    </tr>
                </thead>
                <tbody>
                <?php foreach ($products['products'] as $p):
                    ...
                    $rbadge    = match ($p['risk']) {
                        'critical' => 'badge-pill red',
                        'high'     => 'badge-pill orange',
                        'medium'   => 'badge-pill amber',
                        default    => 'badge-pill',
                    };
...
(function () {
    ...
    menu.querySelectorAll('.custom-days-option').forEach(function (opt) {
        opt.addEventListener('click', function () {
            ...
            menu.querySelectorAll('.custom-days-option').forEach(function (o) {
        ...
        datasets: [
            {
                ...
                pointRadius:             0,
                pointHoverRadius:        4,
                pointHoverBackgroundColor: '#e8611a'
            },
            {
                label:                   'Forecast',
                data:                    foreData,
    ...
    options: {
        ...
        plugins: {
            ...
            tooltip: {
                ...
                callbacks: {
                    label: function (c) {
                        return ' ' + c.dataset.label + ': ₱' + Number(c.parsed.y || 0).toLocaleString();
                    }
                }
            }
        },
